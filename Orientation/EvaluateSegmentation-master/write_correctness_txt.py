...
def write_labels_txt_file(input_file, points, target_file, label_correct=1, label_wrong=2):
    ...
    correctness = len(points)/len(rawdata['vertex'])*100
    ...
    write_header(f, correctness, input_file)
